...
#  las letras minúsculas, otra con todas las letras mayúsculas y otra solo con la primera letra del nombre y de los apellidos
...
print("Ejercicio 6:")
frasev=str(input("Ingrese frase:"))
vocal=str(input("Ingrese vocal en minuscula:"))
print(frasev.replace(vocal, vocal.upper()))
...
# pantalla, el día, el mes y el año. Adaptar
...
#Escribir un programa que pregunte el nombre el un producto, su precio y un número de unidades y muestre por pantalla una cadena con el nombre del producto seguido de su precio unitario con 6 dígitos enteros
...
unidades=int(input("cantiodad de unidades:"))
